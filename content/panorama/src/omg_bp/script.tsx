...
export const OMGBP = () => {
    ...
    function ClickList (Player_box_index: number, key_string: keyof BPList, index: number, PlayerID: number, panel: Panel,State: number) {
    ...
    if(LocalPlayerInfo.player_id != -1 && LocalPlayerInfo.player_id != 23 && Game.GetMapInfo().map_name != `maps/dota.vpk`){
        ...
        return useMemo(
            ...
            [BpListALl, State, BpListResultAll]
        );
    }else{
        //观战
        return <>
    ...
    function Player_box({
        ...
        team == DOTATeam_t.DOTA_TEAM_GOODGUYS ? 'moriya' : 'hakurei';
                ...
                <Panel className="Player_box" style={{ marginLeft: margin_left, marginRight: margin_right }}>
                    <Panel className="my_player_data" style={{ marginTop: State == 3 ? '20%' : '2px'}}>
                        <Panel style={{width: '100%', height: '50px' ,flowChildren: 'right'}}>
                            ...
                            <DOTAUserName className="Player_box_element" style={{ color: '#C0C0C0',marginLeft: '10px',horizontalAlign: 'left' }} steamid={PlayerSteamID} />
                        </Panel>
                    </Panel>
                    <Panel className="show_box">
                        <Panel className="hero_img_box" id={`${team_tag}_hero_${Player_box_index}`} onactivate={panel => PanelFlash(panel, Player_box_index,team)}>
                    ...
                    <Panel className="enemy_player_data" style={{ marginTop: State == 3 ? '5%' : '5px'}}>
                        <Panel style={{width: '100%', height: '50px' ,flowChildren: 'right'}}>
                            ...
                            <DOTAUserName className="Player_box_element" style={{ color: '#C0C0C0',marginLeft: '10px',horizontalAlign: 'left' }} steamid={EnemyPlayerSteamID} />
                        </Panel>
                    </Panel>
                    <Panel className="show_box" style={{visibility: State == 3 ? 'visible' : 'collapse'}}>
                        <Panel className="hero_img_box"  id={`${enemy_team_tag}_hero_${Player_box_index}`} onactivate={panel => PanelFlash(panel, Player_box_index,team)}>
                        ...
                        new Array(5).fill(0).map((item, index) => {
                            ...
                            return (
                                ...
                                <Panel key={index+1} className='' style={{width: '100%', height: '30px' , flowChildren: 'left', visibility:visibility}}>
                                    ...
                                    <Label className="Player_box_element" style={{ color: '#C0C0C0',marginRight: '20%' }} text={`${info_name}发起交换`} />
                                </Panel>
                            )
                        })
                    }
